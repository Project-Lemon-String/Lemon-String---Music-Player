...
public class CreatePlaylistController implements Initializable{
    ...
    void createPlaylist(MouseEvent event) throws Exception{
        ...
        try{
            ...
            CurrentUserData.playlist.add(playlistField.getText());
            CurrentUserData.playlistItems.add(playlistField.getText());
